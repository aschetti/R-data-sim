...
If you wish to generate data similar to an already existing dataset, I recommend the  [`synthpop`](https://cran.r-project.org/web/packages/synthpop/index.html). A separate workshop demonstrates how to use this great package to generate synthetic data of various complexity.
