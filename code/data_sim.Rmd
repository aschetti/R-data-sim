...
ttest_onesample_n <- 50 # number of samples (here, participants)
ttest_onesample_mu_cond <- 1 # variable means
ttest_onesample_sd_cond <- 1 # variable standard deviations
...
ttest_onesample_data <-
  sim_design(
    ...
    empirical = FALSE, # data sampled from a population with specified parameters (not exact)
...
ttest_between_n <- c(50, 50)
ttest_between_mu_cond <- c(1, 2)
ttest_between_sd_cond <- c(1, 1.2)
...
# parameters
ttest_within_within <- list(condition = c("neutral", "emotion"))
ttest_within_n <- c(50, 50)
ttest_within_mu_cond <- c(1, 2)
ttest_within_sd_cond <- c(1, 1.2)
...
ANOVA_n <- list(
  control = c(neutral = 50, unpleasant = 50, pleasant = 50),
  drug = c(neutral = 50, unpleasant = 50, pleasant = 50)
)
ANOVA_mu_cond <- list(
  control = c(neutral = 1, unpleasant = 1.5, pleasant = 1.5),
  drug = c(neutral = 1.5, unpleasant = 2, pleasant = 2.1)
)
ANOVA_sd_cond <- list(
  control = c(neutral = 1, unpleasant = 1.2, pleasant = 1.2),
  drug = c(neutral = 1.2, unpleasant = 1.2, pleasant = 1.2)
)
ANOVA_r <- .5
