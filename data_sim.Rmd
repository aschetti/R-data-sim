...
## Compare Original and Synthetic Dataset
### Graph Raw Data
### Graph Posterior Distributions of Fixed Effects
...
Open Data are amazing
Sometimes data cannot be shared, e.g., because they are proprietary or sensitive 
Solution: simulate dataset (see [Quintana, 2020](https://elifesciences.org/articles/53275))

# Synthesize Simulated Data

Typically you want to synthesize existing data. However, here we will synthesize **simulated** data.

## Data Simulation

We use functions in the package [`faux`](https://debruine.github.io/faux/index.html) by Lisa DeBruine

We use a slightly modified example in the [preprint by DeBruine & Barr](https://psyarxiv.com/xp5cy/)
